...
fitness_function = s -> fitness_evaluation(s,x->(stripe_indicator(x,min_width,lower_bound,upper_bound),stripe_vary_centre_width(x,max_conc,centre_p,width_p)),output_gene);
